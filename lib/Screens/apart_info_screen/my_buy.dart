...
class MyBuyApartPage extends StatefulWidget {
  const MyBuyApartPage({super.key});

  @override
  State<MyBuyApartPage> createState() => _MyBuyApartPageState();
}

class _MyBuyApartPageState extends State<MyBuyApartPage> {
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('tutanKullaniciEmail', isEqualTo: currentUserEmail)
            .snapshots(),
